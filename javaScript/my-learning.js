...
window.MyLearning = {
    ...
    _debug: null,
    _version: null,
    _PANsBaseUrl: 'https://www.Piparaacademy.com',
    _profileBaseUrl: 'https://profile.Piparaacademy.com',
    _linkTargetAttr: '',
    _myLearningBaseUrl: 'https://my-learning.Piparaacademy.com'
  };
  ...
  MyLearning._version_to_base_url_map = {
    '1': 'https://mypage.Piparaacademy.com',
    '1.5': 'https://my-learning.Piparaacademy.com',
    '1.5L': 'https://my-learning-legacy.Piparaacademy.com',
    '2': 'https://myl-api.Piparaacademy.com',
    '2.1': 'https://myl-api.Piparaacademy.com',
    '3': 'https://myl-api.Piparaacademy.com',
    '3-dev': 'https://my-learning.Piparaacademy.com'
  }
  ...
  MyLearning._version_and_name_to_rel_url_map = {
    ...
    '2': {
      'api.meta': '/api/modern/get-set-topic-progress',
      // 'api.meta_for_default': '/api/meta-for-default/', // deprecated
      'api.exercise.get': '/api/modern/get-Notes-progress',
      'api.exercise.set': '/api/modern/set-Notes-progress',
      'api.quiz.set_score': '/api/modern/set-quiz-progress'
    },
    '2.1': {
      'api.meta': '/api/modern/get-set-topic-progress',
      'api.exercise.get': '/api/modern/get-Notes-progress',
  ...
  // usage:
  // MyLearning.getUrl('api.quiz.set_score') -> https://mypage.Piparaacademy.com/mypage/set_quiz_score2.php
  ...
  MyLearning.showQuizScoreProfileBtn = function () {
    document.getElementById('user-profile-quiz-score-wrapper').classList.remove('PAN-hide');
  }
  // > footer
  // >> modern